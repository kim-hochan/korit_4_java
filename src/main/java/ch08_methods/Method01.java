...
//        result = "대입 불가";
        call3();    // 이거 실행이 안됨.
        System.out.println(call3());    // call(0는 출력하라는 명령문이 메서드 내에 정의도어있지 않음
        // 이상을 이유로 sout이 main단계에서 요구됨.

        System.out.println(call4(2024, 4, 24, "목요일"));
        System.out.println(introduce("김호찬", 26));
        /*
            Scanner 클래스를 import하시고
            String name / int age를 선언하신 후에
            name / age에 각각 김호찬 26을 대입한 후에
            introduce 에 agrgument로 써서
            제 이름은 김호찬입니다. 나이는 26살입니다.
            내년에는 27살이 됩니다.
            를 출력하시오.
         */
        // Scanner import
